...
<!--[if gt IE 9]><!--> <html class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <title>Rapipets</title>

        <meta name="description" content="Rapipets">
    ...
    <body>  
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <aside id="side-overlay">
                ...
                <div id="side-overlay-scroll">
                    ...
                    <div class="side-header side-content">
                        ...
                        <span>
                            <img class="img-avatar img-avatar32" src="<?php echo BASE_PATH ?>/assets/img/avatars/avatar10.jpg" alt="">
                                            ...
                                            <ul class="nav-users remove-margin-b">
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo BASE_PATH ?>/assets/img/avatars/avatar7.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo BASE_PATH ?>/assets/img/avatars/avatar13.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo BASE_PATH ?>/assets/img/avatars/avatar3.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo BASE_PATH ?>/assets/img/avatars/avatar2.jpg" alt="">
                                                ...
                                                <li>
                                                    <a href="base_pages_profile.html">
                                                        <img class="img-avatar" src="<?php echo BASE_PATH ?>/assets/img/avatars/avatar16.jpg" alt="">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white-op">
                            ...
                            <a class="h5 text-white" href="index.php">
                                <span class="h4 font-w600 sidebar-mini-hide">Rapipets Admin</span>
                            </a>
                        </div>
                        <!-- END Side Header -->
                    ...
                    <li>
                        <div class="btn-group">
                            <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                                <img src="<?php echo BASE_PATH ?>/assets/img/avatars/avatar10.jpg" alt="Avatar">
            ...
            <footer id="page-footer" class="content-mini content-mini-full font-s12 bg-gray-lighter clearfix">
                ...
                <div class="pull-left">
                    <a class="font-w600" href="http://goo.gl/6LF10W" target="_blank">Rapipets 3.0</a> &copy; <span class="js-year-copy"></span>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
        ...
        <script src="<?php echo BASE_PATH ?>/assets/js/core/jquery.slimscroll.min.js"></script>
        <script src="<?php echo BASE_PATH ?>/assets/js/core/jquery.scrollLock.min.js"></script>
        <script src="<?php echo BASE_PATH ?>/assets/js/core/jquery.appear.min.js"></script>
        <script src="<?php echo BASE_PATH ?>/assets/js/core/jquery.countTo.min.js"></script>
        <script src="<?php echo BASE_PATH ?>/assets/js/core/jquery.placeholder.min.js"></script>
        <script src="<?php echo BASE_PATH ?>/assets/js/core/js.cookie.min.js"></script>
